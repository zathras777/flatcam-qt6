...
class KeySensitiveListView(QTreeView):
    ...
    def __init__(self, parent=None):
        ...
        #self.setEditTriggers(QTreeView.
        #            QTreeView.SelectionMode.SelectionBehaviour. SelectedClicked)
...
class ObjectCollection(QAbstractItemModel):
    """
    ...
    def on_key(self, key):
        ...
        if key == Qt.Key.Key_Delete and active:
