...
from vispy.scene import SceneCanvas, AxisWidget, GridLines, PanZoomCamera
...
class VisPyCanvas(SceneCanvas):
    ...
    def __init__(self, config=None):
        ...
        yaxis = AxisWidget(orientation='left', axis_color='black', text_color='black', font_size=12)
        yaxis.width_max = 60
        grid.add_widget(yaxis, row=1, col=0)

        xaxis = AxisWidget(orientation='bottom', axis_color='black', text_color='black', font_size=12)
        xaxis.height_max = 40
        ...
        grid1 = GridLines(parent=view.scene, color='gray')
