...
from PyQt6.QtWidgets import QSizePolicy, QLabel, QFrame
...
class Measurement(FlatCAMTool):
    ...
    def __init__(self, app):
        ...
        self.label.setFrameStyle(QFrame.Shape.StyledPanel | QFrame.Shadow.Plain)
    ...
    def install(self, icon=None, separator=None, **kwargs):
        super().install(icon, separator, **kwargs)
