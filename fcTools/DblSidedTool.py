...
from PyQt6.QtWidgets import QLabel, QFormLayout, QComboBox, QVBoxLayout, QHBoxLayout, QPushButton
...
class DblSidedTool(FlatCAMTool):
    ...
    def __init__(self, app):
        ...
        self.object_combo.setRootModelIndex(self.app.collection.index(0, 0, QModelIndex()))
        ...
        self.box_combo.setRootModelIndex(self.app.collection.index(0, 0, QModelIndex()))
